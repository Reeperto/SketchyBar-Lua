static const char help_str[] = {
    ...
    "Set global bar properties, see "
    "https://felixkratz.github.io/SketchyBar/config/bar\n"
    "      --bar <setting>=<value> ... <setting>=<value>\n\n"
    "Items and their properties, see "
    ...
    "                                  \tChange default properties for new "
    "items\n"
    ...
    "Special components, see "
    "https://felixkratz.github.io/SketchyBar/config/components\n"
    ...
    "      --query default_menu_items\tQuery names of available items for "
    "aliases\n\n"
    "Animations, see "
    ...
    "                --set <name> <property=value> ... <property=value>\n"
    "                         \tAnimate from given source to target property "
    "values\n\n"
    "Reloading the config\n"
    "      --hotload <boolean>        \tEnable or disable the config "
    "hotloader\n"
    "      --reload [optional: <path>]\tReload the current or the given "
    "config\n\n"};
